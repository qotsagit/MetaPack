...
namespace MetaPack.Common
{
    ...
    static class Settings
    {
        ...
        {
            get { return GetString("SMTPEmailTo", Config.DefaultSMTPEmailTo); }
            set { SetString("SMTPEmailTo", value); }
        }

        public static string SMTPEmailFrom 
        {
            get { return GetString("SMTPEmailFrom", Config.DefaultSMTPEmailFrom); }
            set { SetString("SMTPEmailFrom", value); }
        }
        public static string SMTPHost
        {
            get { return GetString("SMTPHost", Config.DefaultSMTPHost); }
            set { SetString("SMTPHost", value); }
        }

        public static string SMTPUser
        {
            get { return GetString("SMTPUser", Config.DefaultSMTPUser); }
            set { SetString("SMTPUser", value); }
        }

        public static string SMTPPassword
        {
            get { return GetString("SMTPPassword", Config.DefaultSMTPPassword); }
            set { SetString("SMTPPassword", value); }
        }

        public static int SMTPPort
        {
            get { return GetInt("SMTPPort", Config.DefaultSMTPPort); }
